    ...
    <div class="row">
        <div class="col-sm-12 col-md-4 img-container">
            <div id="image_wraper" style="position: relative;">
                <img id="profile_pich" src="<?php echo $img_path ?>"
                    style="margin: 0%;padding:0%;width:250px;height:250px;">
                <button id="profileImage" class="profileUpload btn btn-warning btn-sm"
                    onclick="document.getElementById('imageUpload').click()" style="border-radius: 50%;">
                ...
                <form action="Student_profile_pick_upload.php" method="post" style="display: none;"
                    enctype="multipart/form-data">
                    <input id="imageUpload" onchange="" name="path" type="file"
