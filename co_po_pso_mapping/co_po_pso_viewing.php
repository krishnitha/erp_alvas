<?php
    ...
    if($_SESSION["f_co"] == 0){
        ...
        foreach($result5 as $res5){
            if($res5["sub"] == $_POST["sub"])
                $flag_check1 = 1;
        }
        foreach($result6 as $res6){
            if($res6["sub"] == $_POST["sub"])
                $flag_check2 = 1;
        }
        if(!$flag_check1){
            // echo "in";
  ...
  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
    ...
    <div class="row mt-5">
        ...
        <div class="col col-10 col-md-10 col-lg-10">
            <textarea type="text" readonly name="co1" class="form-control"><?php if(empty($res1["co1"])) echo "N/A";else echo $res1["co1"]; ?></textarea>
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col col-10 col-md-10 col-lg-10">
            <textarea type="text" readonly name="co2" class="form-control"><?php if(empty($res1["co2"])) echo "N/A";else echo $res1["co2"]; ?></textarea>
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col col-10 col-md-10 col-lg-10">
            <textarea type="text" readonly name="co3" class="form-control"><?php if(empty($res1["co3"])) echo "N/A";else echo $res1["co3"]; ?></textarea>
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col col-10 col-md-10 col-lg-10">
            <textarea type="text" readonly name="co4" class="form-control"><?php if(empty($res1["co4"])) echo "N/A";else echo $res1["co4"]; ?></textarea>
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col col-10 col-md-10 col-lg-10">
            <textarea type="text" readonly name="co5" class="form-control"><?php if(empty($res1["co5"])) echo "N/A";else echo $res1["co5"]; ?></textarea>
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col col-10 col-md-10 col-lg-10">
            <textarea type="text" readonly name="co6" class="form-control"><?php if(empty($res1["co6"])) echo "N/A";else echo $res1["co6"]; ?></textarea>
        </div>
    </div>
      ...
      <div class="container">
          ...
          <div class="row mt-5">
              ...
              <div class="col col-9 col-md-9 col-lg-9">
                    <textarea type="text" name="pso" class="form-control" readonly><?php if(!empty($res2["pso" . $i])) echo $res2["pso" . $i]; else echo "N/A";  ?>
                    </textarea>
              </div>
                ...
                <tr>
                        ...
                        <td>
                                ...
                                <select id="slct" required="required" name="po1<?php echo $i ?>">
                                    <option><?php if($res7["po1"] == "0") echo "N/A"; else echo $res7["po1"]; ?></option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="po2<?php echo $i ?>">
                                    <option><?php if($res7["po2"] == "0") echo "N/A"; else echo $res7["po2"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="po3<?php echo $i ?>">
                                    <option><?php if($res7["po3"] == "0") echo "N/A"; else echo $res7["po3"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required"  name="po4<?php echo $i ?>">
                                    <option><?php if($res7["po4"] == "0") echo "N/A"; else echo $res7["po4"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required"  name="po5<?php echo $i ?>">
                                    <option><?php if($res7["po5"] == "0") echo "N/A"; else echo $res7["po5"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="po6<?php echo $i ?>">
                                    <option><?php if($res7["po6"] == "0") echo "N/A"; else echo $res7["po6"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="po7<?php echo $i ?>">
                                    <option><?php if($res7["po7"] == "0") echo "N/A"; else echo $res7["po7"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required"  name="po8<?php echo $i ?>">
                                    <option><?php if($res7["po8"] == "0") echo "N/A"; else echo $res7["po8"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="po9<?php echo $i ?>">
                                    <option><?php if($res7["po9"] == "0") echo "N/A"; else echo $res7["po9"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="po10<?php echo $i ?>">
                                    <option><?php if($res7["po10"] == "0") echo "N/A"; else echo $res7["po10"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="po11<?php echo $i ?>">
                                    <option><?php if($res7["po11"] == "0") echo "N/A"; else echo $res7["po11"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="po12<?php echo $i ?>">
                                    <option><?php if($res7["po12"] == "0") echo "N/A"; else echo $res7["po12"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                  ...
                  <tr>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="pso1<?php echo $j ?>">
                                    <option><?php if($res7["pso1"] == "0") echo "N/A"; else echo $res7["pso1"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="pso2<?php echo $j ?>">
                                    <option><?php if($res7["pso2"] == "0") echo "N/A"; else echo $res7["pso2"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="pso3<?php echo $j ?>">
                                    <option><?php if($res7["pso3"] == "0") echo "N/A"; else echo $res7["pso3"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="pso4<?php echo $j ?>">
                                    <option><?php if($res7["pso4"] == "0") echo "N/A"; else echo $res7["pso4"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <td >
                                ...
                                <select id="slct" required="required" name="pso5<?php echo $j ?>">
                                    <option><?php if($res7["pso5"] == "0") echo "N/A"; else echo $res7["pso5"]; ?></option>
                                    <option value="N/A">N/A</option>
                                    <option value="Low">Low</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
