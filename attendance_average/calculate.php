...
$date1=str_replace("-","_",$_POST["startdate"]);
    ...
    $q1="select " . $r6["Column_Name"] . " from attendance where " . $r6["Column_Name"] . " is null and branch='" . $_POST["dept"] . "' and sem=" . $_POST["sem"] . " and section='" . $_POST["sec"] . "' and subject='" . $_POST['sub'] . "';";
    // echo $q1;
...
$q3 = "select * from attendance where branch=\"" . $_POST["dept"] . "\" and sem=\"" . $_POST["sem"] . "\" and section=\"" . $_POST["sec"] . "\" and subject=\"" . $_POST['sub'] . "\" order by usn;";
 $result3=$link->query($q3);
//  echo $q3;
$q6 = "select * from marks where branch=\"" . $_POST["dept"] . "\" and sem=\"" . $_POST["sem"] . "\" and sec=\"" . $_POST["sec"] . "\" and sub=\"" . $_POST['sub'] . "\" order by usn;";
$result5=$link->query($q6);  
foreach($result3 as $r3){           
// print_r($f);
if(!mysqli_num_rows($result5)){
$q5="insert into marks(`usn`, `name`, `branch`, `sem`, `sec`, `sub`,`att_avg`) values ( \"" . $r3["usn"] . "\", \"" . $r3["name"] . "\",  \"" . $_POST["dept"] . "\", \"" . $_POST["sem"] . "\", \"" . $_POST["sec"] . "\",\"" . $_POST['sub'] . "\", 0)";
$link->query($q5);
}
$c1=0;
    foreach($f as $v){
        $q2 = "select " . $v . " from attendance where branch=\"" . $_POST["dept"] . "\" and sem=\"" . $_POST["sem"] . "\" and section=\"" . $_POST["sec"] . "\" and subject=\"" . $_POST['sub'] . "\" and usn=\"" . $r3["usn"] . "\";"; 
        // echo $q2;
 ...
 $q4="update marks set att_avg=" . (($c1/$c)*100) . " where branch=\"" . $_POST["dept"] . "\" and sem=\"" . $_POST["sem"] . "\" and sec=\"" . $_POST["sec"] . "\" and sub=\"" . $_POST['sub'] . "\" and usn=\"" . $r3["usn"] . "\";"; 
//  echo $q4;
//  echo $c;
//  echo $r3["usn"];
//  echo $c1;
...
<thead class="thead-secondary">
    ...
    <?php 
        $q5="select * from marks where branch=\"" . $_POST["dept"] . "\" and sem=\"" . $_POST["sem"] . "\" and sec=\"" . $_POST["sec"] . "\" and sub=\"" . $_POST['sub'] . "\" order by usn;";
