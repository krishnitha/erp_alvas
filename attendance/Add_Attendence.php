...
// echo $_SESSION["temp"];
    ...
    // echo $_SESSION["temp"];
    $q5="update attendance set " . $date1 . "_" . $period . "=1 where sem=\"" . $sem . "\" and section=\"" . $sec . "\"and subject=\"" . $sub . "\";";
            // echo $q5;
            $link->query($q5);
        ...
        .form-check-input {
            ...
            border: #db3967;
                ...
                <!-- table -->
                    ...
                    <?php
                     $se="select usn,name," . $date3 . " from attendance where sem=\"" . $sem . "\" and section=\"" . $sec . "\"and subject=\"" . $sub . "\"";
                    ...
                    <thead class="thead-secondary">
                            <tr>
                                ...
                                <th scope="col" style="text-align: center;"><?php echo $date ?></th>
