      ...
      <select class="form-control" name="sub" id="sub" aria-label="Default select example">
        ...
        <?php
          if (isset($_SESSION['dept_admin']) && $_SESSION['dept_admin'] == 1) {
            ...
            $qt = "select a.sub_name, a.sub_code,a.lab from faculty_mapping b, subjects a where b.faculty_name = \"" . $_SESSION["username"] . "\" and b.sub_name = a.sub_name and branch = '" . $dept . "'";
          }
