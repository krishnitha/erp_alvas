        ...
        <div class="col-md-6 mb-3">
            ...
            $qt = 'selet * from subjects where branch = "' . $dept . '"';
                if(isset($_SESSION['dept_admin']) && $_SESSION['dept_admin'] == 1){
                    ...
                    $qt = "select a.sub_name, a.sub_code,a.lab from faculty_mapping b, subjects a where b.faculty_name = \"" . $_SESSION["username"] . "\" and b.sub_name = a.sub_name and a.branch = '" . $dept . "'";
                }
                echo $qt;
