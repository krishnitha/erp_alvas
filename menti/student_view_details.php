...
?>
                <div class="container">
                  ...
                  $que = "select * from students s,mentor_mapping m, parents_details p, puc_details pu, sslc_details ss where s.usn=m.usn and s.adm_no = ss.adm_no and ss.adm_no = pu.adm_no and pu.adm_no = p.adm_no and batch=\"" . $_POST["batch"] . "\" and branch=\"" . $_POST["branch"] . "\" and m.fac_name=\"" . $_SESSION["username"] . "\"";
                    ...
                    ?><form action="student_update_details.php" method="POST">
                            ...
                            <form action="student_delete_details.php" method="POST">
                                ...
                                <div class="form-group col-md-5">
                                    <label for="usn">Admission Number :</label>
...
<!-- 
    ...
    <body>
            ...
            <div class="modal-body ">
                ...
                ?>
            <button  style="height:40px;width=50% " onclick="window.print()" type="submit" class="btn btn-success">Print</button>
    ...
    <!-- Metting -->
    <?PHP
      $que2 ="select * from shedule m,mentor_mapping k,students s where s.usn=m.usn and k.usn=m.usn and k.usn= \"" .$row["usn"]. "\" and s.batch=\"" . $_POST["batch"] . "\" and s.branch=\"" . $_POST["branch"] . "\" and k.fac_name=\"" . $_SESSION["username"] . "\"";
