			...
			if ($k == 0) continue;
				...
				foreach($result1 as $r1)
				{
					...
					if($r1['adm_no']==$r[0] && $r1['usn']==$r[1]&& $r1['branch']==$r[3] && $r1['sem']==$r[4] && $r1['sec']==$r[5] && $r1['sub']==$r[6])
					{
						...
						$q="UPDATE `ia_marks1` SET `1a`='". $r[7] ."',`1b`='". $r[8] ."',`1c`='". $r[9] ."',`2a`='". $r[10] ."',`2b`='". $r[11] ."',`2c`='". $r[12] ."',`3a`='". $r[13] ."',`3b`='". $r[14] ."',`3c`='". $r[15] ."',`4a`='". $r[16] ."',`4b`='". $r[17] ."',`4c`='". $r[18] ."',`total1`='". $r[19] ."' WHERE  adm_no= '". $r[0] ."' and `branch`='" . $r[3] . "' and `sem`='" . $r[4] . "' and `sec`='" . $r[5] . "' and `sub`='" . $r[6] . "'";
						// echo $q;
						$result=$con->query($q);
