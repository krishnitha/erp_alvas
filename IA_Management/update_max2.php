...
// $flag=$_POST['1c'] ?? 0;
// echo $flag;
$q="insert into ia2_max_marks values(\"" . $r1[0] . "\",\"" . $branch . "\"," . ($_POST['1a'] ?? 0) . "," . ($_POST['1b'] ?? 0) . "," . ($_POST['1c'] ?? 0) . "," . ($_POST['2a'] ?? 0) . "," . ($_POST['2b'] ?? 0) . "," . ($_POST['2c'] ?? 0) . "," . ($_POST['3a'] ?? 0) . "," . ($_POST['3b'] ?? 0) . "," . ($_POST['3c'] ?? 0) . "," . ($_POST['4a'] ?? 0) . "," . ($_POST['4b'] ?? 0) . "," . ($_POST['4c'] ?? 0) . ");";
// echo $q;
