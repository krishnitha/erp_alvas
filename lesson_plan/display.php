...
error_reporting(0);
    $con = $link;
        ...
        //   echo $sem;
          // echo  $_SESSION["vtu"];
            $q = "select module, dop_Plan, pending, textbook, co, bt_evel, vtu_textbook, vtu_co from lessonpanl where sem = \"" . $sem . "\" and subid = \"" . $subid . "\" and section = \"" . $sec . "\" and branch = \"" . $branch . "\"";
            // echo $q;
            $result = $con -> query($q);
            // $vtu = $_SESSION["vtu"];
            // $arr1 = explode(".", $vtu);
