...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <button type="button" class="btn btn-info mt-5" data-toggle="modal" data-target="#staticBackdrop"
            ...
            <div  class="table-responsive" style="width:75vw; height:80vh;">
                <table style=" overflow:scroll; height:50vh; width:max-content;"
 class="table table-striped mt-5">
              ...
              ?>
                    ...
                    ?><td></td><?php
                                ...
                                <th><input class="form-control" type="date" name="dop_Plan<?php echo $con1 ?>"
                                        value="<?php echo $r['dop_Plan'] ?>" readonly></th>

                                <td><textarea class="form-control" cols="100" rows="7" name="topic<?php echo $con1 ?>"
                                        readonly><?php echo $r['pending'] ?></textarea></td>
                                <td><textarea class="form-control" cols="20" rows="7" name="textbook<?php echo $con1 ?>"
                                        readonly><?php echo $r['textbook'] ?></textarea></td>
                    ...
                    ?>
                                ...
                                <td><input list="comp<?php echo $con1 ?>" class="form-control" id="comp_in"
                                        name="compin" value="<?php echo $r['complet'] ?>">
