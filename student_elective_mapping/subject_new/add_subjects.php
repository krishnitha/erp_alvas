    ...
    flex-direction: row;">
            ...
            <div class="col">
                <div style="display: flex;" class="p-0 m-0">
                    ...
                    <input id="pro_elective" type="radio" name="type" style="width: 20px; height: 20px;" value="PROFESSIONAL_ELECTIVE">Professional Elective
                </div>
                <div style="display: flex;" class="p-0 m-0">
                    <input id="open_elective" type="radio" name="type" style="width: 20px; height: 20px;" value="OPEN_ELECTIVE">Open Elective
                </div>
                <div style="display: flex;" class="p-0 m-0">
                    <input id="special" type="radio" name="type" style="width: 20px; height: 20px;" value="SPECIAL">Special Subject
                </div>
    
                <div style="display: flex;" class="p-0 m-0">
                    <input id="lab" type="radio" name="type" style="width: 20px; height: 20px;" value="LAB">LAB
                </div>
            </div>
            <div class="col-sm-12 col-md-4">
                <div class="form-group ">
