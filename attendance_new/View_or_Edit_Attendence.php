                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            foreach ($display_dates as $d) {
                                $q_stud = 'select * from attendance_new where sub="' . $sub . '" and sem="' . $sem . '" and sec="' . $sec . '" and branch="' . $branch . '" and usn = "' . $r['usn'] . '";';
                            ...
                            <td>
                                ...
                                <div class="form-check form-switch mx-auto">
                                    <input class="form-check-input form-success" type="checkbox"
                                        id="cell-<?php echo $i . '-' . $iii ?>" name='row<?php echo $i . $iii ?>'
                                        <?php if ($a) {
                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                    } ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-3"></div>
                                <div class="col-3">
                                    <button class="btn btn-info " id="up_col-<?php echo $i ?>"
                                        onclick="update_col(this.id)"><i class="fas fa-floppy-o"></i></button>
                                ...
                                <div class="col-3">
                                    <form action="del_col.php" id="form-<?php echo $i ?>" method="post">
                                        <input type="text" name="date" value="<?php echo $r ?>" hidden>
                                        <button class="btn btn-danger" type="submit" id="del_col-<?php echo $i ?>"> <i
