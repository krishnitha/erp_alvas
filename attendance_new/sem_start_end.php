    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th scope="col" required>End Date</th>
                <th></th>
                <th></th>
            </tr>
        </thead>
            ...
            <form action="update_row_start_end.php" method="post">
                <tr>
                    <th scope="row"><input type="text" name="sem" id="" value="<?php echo $r['sem'] ?>" hidden>
                        <?php echo $r['sem'] ?></th>
                    <td><input class="form-control" type="date" name="start" id="" value="<?php echo $r['start'] ?>">
                    </td>
                    <td><input class="form-control" type="date" name="end" id="" value="<?php echo $r['end'] ?>"></td>
                    <td>
