...
<!-- IA --->
      ...
      <?PHP
      $que1 ="select * from marks k,mentor_mapping m,students s where s.usn=k.usn and s.usn=m.usn and s.semester=k.sem and m.usn = k.usn and k.usn= \"" .$row["usn"]. "\" and s.semester=\"" . $_POST["sem"] . "\" and m.fac_name=\"" . $_POST["elective"] . "\"";
                        $result1 = $con->query($que1);
        ?>                
