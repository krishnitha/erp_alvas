    ...
    <div class="wrapper page">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#page" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Mentor</a>
                ...
                <li>
                    <a href="../lab_marks/lab.php" id="ia">LAB Marks</a>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="downloadSubmenu">
                        ...
                        <li>
                            ...
                            <a href="#iamarkSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">IA Marks</a>
                        </li>
                ...
                <li>
                    <a href="#Gen_report" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Generate
                        Report</a>
                    ...
                    <ul class="collapse list-unstyled" id="Dept_submenue">
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="pageSubmenu1232">
                                <li>
                                    <a href="../attainment/attainment_target.php">Attainment Target</a>
                                </li>
                                <li>
                                    <a href="../attainment/redirect_attainment_dept_admin.php">Attainment Report</a>
                                </li>
                                <?php if ($_SESSION['username'] == 'Shilpa') { ?>
                                    <li>
                        ...
                        <li class="">
                            <a href="../mentor/drop_view_dis.php">Mentor-Student mapping</a>
                        </li>

                        <li class="">
                            <a href="../mentor/mentor_select_dis.php">VIEW MENTOR-MENTEE</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="homeSubmenu">
                                ...
                                <li>
                                    <a href="../dept_admin/select_sub_branch.php">View Subject</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#DeptAdminSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Faculty-Subject Mapping</a>
